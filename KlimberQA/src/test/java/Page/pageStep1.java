...
public class pageStep1 {
	...
	By buttonContratar = By.id("btnSaveStep1");
	By titleStep1 = By.xpath("//*[@id=\"frmIndex\"]/div[1]/div[1]");
	...
	public void assertErrorIncorrectPhoneNumber() throws HeadlessException, InvalidFormatException, IOException, AWTException {
		WebElement message = driver.findElement(messageError);
		String textMessage = message.getText();
		String Valor_esperado = "Por favor, ingresá un valor entre 6 y 20 caracteres.";
		Assert.assertEquals(textMessage,Valor_esperado);
		GenerarReporte.Paso("Se valida que muestra un mensaje de erorr al escribir un numero de telefono incorrecto, se muestra el siguiente mensaje de error: " + textMessage);
	} 
	
	public void goStep2() throws HeadlessException, InvalidFormatException, IOException, AWTException {
		driver.findElement(buttonContratar).click();
		GenerarReporte.Paso("Se pasa al siguiente paso de la contratación");
	} 
	
	public void assertYouAreOnStep1() throws HeadlessException, InvalidFormatException, IOException, AWTException {
		WebElement title = driver.findElement(titleStep1);
		String textTitle = title.getText();
		String Valor_esperado = "Elegí cuánto querés pagar por tu seguro de vida";
		Assert.assertEquals(textTitle, Valor_esperado);
		GenerarReporte.Paso("Se valida que estas en el step 1");
	} 
